...
#writing the progress data into a text file

data = []

#open file in write mode

file = open("progression_data","w")
...
def main():
    ...
    #writting input data into the text file
    
    #for element in progress_list:
       # file.write(element + "\n")

    #for element in trailer_list:
        #file.write(element + "\n")

    #for element in retriever_list:
        #file.write(element + "\n")
    ...
    #open file again in reading mode
